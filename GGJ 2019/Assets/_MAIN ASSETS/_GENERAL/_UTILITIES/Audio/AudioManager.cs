...
public class AudioManager : MonoBehaviour
{
	...
	void Init()
	{
		...
		//Mute
		soundChannel.mute = PlayerPrefsX.GetBool ("soundMuted", false);
		musicChannel.mute = musicChannelCrossfadeHelper.mute = PlayerPrefsX.GetBool ("musicMuted", false);
	...
	void SetMusicMuteInternal (bool state)
	{
		...
		PlayerPrefsX.SetBool ("musicMuted", state);
	}

	void SetSoundMuteInternal (bool state)
	{
		soundChannel.mute = state;
		PlayerPrefsX.SetBool ("soundMuted", state);
	}
